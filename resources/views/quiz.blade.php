...
{{--                    @endif--}}
                @endforeach
                <button style="width: 100%" type="submit" class="btn btn-success btn-sm">End exam</button>
            </form>
        </div>
    </div>
</x-app-layout>
